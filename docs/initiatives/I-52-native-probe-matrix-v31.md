# I-52 — Native Probe Matrix V31

> **NPM-V31-1 / NORMATIVE / NOT EXECUTED.** Parent NPM-V30-1 blob
> `b07e1270dd290328f52eb9f64b8c0e6b2a44675b`. This artifact is the single source of truth for
...
V30 `STATE-CMD-RESULT` is superseded and absent from NPM-V31 because it encoded an outcome selected at runtime.
