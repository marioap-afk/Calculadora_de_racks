...
- **PB-0** (Owner): bloques + catálogo + decisiones funcionales — [decisions/I-18.md](../automation/decisions/I-18.md).
- **I-18a** (esta entrega): núcleo puro + plan + BOM + persistencia + pruebas golden/round-trip.
