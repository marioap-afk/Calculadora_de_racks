# I-52 — Proposal V17: RACKMIRROR, espejo semantico de uno o varios racks (ID16)

> **PROPOSAL V17 — NOT CONSENSUS. Gate exclusivamente documental.**
>
> ```text
...
V17 responde a la revision exacta de V16 transmitida en el relevo del 2026-09-15:
**CHANGES REQUIRED — PROPOSAL V17**. El ejecutor registra esa entrada; no emite una revision del
Arquitecto ni un acuerdo del Coordinador. V16 queda **REVIEWED — CHANGES REQUIRED**. G3 nunca se ha abierto.

Se conserva el modelo de V16 en §§1–21, con las sustituciones identificadas aqui. Los identificadores
historicos `[Vn-Dnn]` conservan su procedencia; su texto anterior no revive una regla sustituida por V17.
V1–V16 y el Discovery quedan intactos. No cambia el schema ni se crea produccion, pruebas productivas,
freeze o aceptacion del Owner. La base de la rama y las citas productivas historicas siguen sin rebase;
los resultados indicativos heredados no son mediciones nuevas ni evidencia G3.

## 0. Reconciliacion V16 → V17

### 0.1 Matriz de decisiones para revision

`CLOSED BY V17` significa redaccion resuelta segun la orden, **no** acuerdo tecnico ni caracterizacion
demostrada. Las autoridades concretas quedan **DEFERRED TO G3 WITH FAIL-CLOSED**. `OPEN MATERIAL = NONE`
describe cuestiones de redaccion elevadas por el ejecutor; no declara que el Arquitecto no pueda hallar otras.

| Marca | Entrada | Resolucion | Estado | Autoridad en V17 |
|---|---|---|---|---|
| `[V17-D01]` | AR16-01 HIGH; V17-01 | Retirar reactores de terceros de la politica runtime de representacion; conservar suscripciones de RackCad en G-M24 | CLOSED BY V17 | §0.3; §11.3; decision 11 del ADR |
| `[V17-D02]` | AR16-01; V17-02 | Clasificar familias de overrules por dibujo, transformacion y ocupacion de modelo: relevante, irrelevante o desconocida | CLOSED BY V17; resultado CT-49 pendiente | §0.3; CT-49 |
| `[V17-D03]` | AR16-01; V17-03 | Aplicabilidad por sujeto y clase de overrule; autoridad global solo como fallback demostrado y expuesto | CLOSED BY V17; autoridad CT-49 pendiente | §0.3; L-34, M-35, R-58 |
| `[V17-D04]` | AR16-02 MEDIUM; V17-04 | Catalogo cerrado de MODOS persistentes antes de seleccionar señales | CLOSED BY V17; catalogo CT-49 pendiente | §0.4; ST-20, PRE-19, E12 |
| `[V17-D05]` | AR16-02; V17-05 | Cada autoridad generica declara predicado, ambito y cobertura demostrada de modos | CLOSED BY V17; cobertura CT-49 pendiente | §0.4; CT-49 |
| `[V17-D06]` | LOW identidad; V17-06 | Fuente fiable de producto, vertical/host y major/API; ausencia en caracterizacion ⇒ STOP; fallo runtime ⇒ E12 | CLOSED BY V17; fuente CT-49 pendiente | §0.4; L-34, R-57 |
| `[V17-D07]` | AR16-03 MEDIUM; V17-07 | AutoCadApiCallCensus cerrado sobre todas las invocaciones alcanzables; UNCLASSIFIED ⇒ RED | CLOSED BY V17; captura CT-50 pendiente | §0.5; §8.7; G-M24; decision 7 del ADR |
| `[V17-D08]` | AR16-03; V17-08 | Fixtures de campos, DataLink, XREF, LayoutManager y UpdateExt, ademas de las anteriores | CLOSED BY V17; ejecucion futura | §0.5; CT-50; T-M75 |
| `[V17-D09]` | AR16-03; V17-09 | Registros de eventos Database, Document, Editor, Application y DocumentCollection; handlers transitivos y diferidos | CLOSED BY V17; ejecucion futura | §0.5; G-M24 |
| `[V17-D10]` | LOW campos; V17-10 | Causalidad recursiva, hojas EDIT fijas, hojas STATE variables; ciclos sin cota finita ⇒ UNKNOWN | CLOSED BY V17; caracterizacion pendiente | §0.6; CT-49; T-M73 |
| `[V17-D11]` | AR16-01; V17-11 | Limitacion practica de overrules en L-34, M-35 y R-58; alcance amplio global explicitado | CLOSED BY V17 | §0.7; O-1 PENDING |
| `[V17-D12]` | LOW casos G3; V17-12 | Casos de modos, host, overrules, censo, campos y XREF obligatorios; ninguna ejecucion G3 | CLOSED BY V17 (plan) | §0.8; §12; §14.2 |
| `[V17-D13]` | V17-13; preflight actual | I-49 A3-R2 con consenso exacto registrado en A3-R3; sucesor/Owner/freeze pendientes; RS-3 sigue pendiente | CLOSED BY V17 (hechos) | §0.9; §15 |
| `[V17-D14]` | V17-14 | ADR propuesto; matriz y proceso sin saltos; contradiccion material ⇒ Proposal V18 | CLOSED BY V17 | §0.10; §14; §21; decisions/I-52 §§98–103 |

### 0.2 Reapertura y precision de la matriz anterior

| Marca anterior | Operacion | Sustitucion vigente |
|---|---|---|
| `[V16-D01]` | REOPENED → CLOSED BY V17 | `[V17-D04]`, `[V17-D05]`: autoridad runtime conservada; su suficiencia exige catalogo previo de modos |
| `[V16-D02]` | REOPENED → CLOSED BY V17 | `[V17-D04]`: el cierre sobre señales no demuestra cierre sobre modos |
| `[V16-D05]` | REOPENED → CLOSED BY V17 | `[V17-D07]`, `[V17-D08]`: familias como fixtures; censo total como cierre |
| `[V16-D06]` | REOPENED → CLOSED BY V17 | `[V17-D09]`: eventos de Application y DocumentCollection y handlers alcanzables |
| `[V16-D07]` | REOPENED → CLOSED BY V17 | `[V17-D01]`–`[V17-D03]`: solo overrules relevantes y aplicables; sin regla de representacion para reactores |
| `[V16-D11]` | REOPENED → CLOSED BY V17 | `[V17-D12]`: nuevos casos obligatorios, sin afirmar ejecucion |
| `[V16-D12]` | REOPENED → CLOSED BY V17 | `[V17-D11]`: limitacion de terceros en L-34/M-35/R-58 |
| `[V16-D13]` | REOPENED → CLOSED BY V17 | `[V17-D14]`: decisiones 7, 11 y 13 alineadas, ADR PROPOSED |
| `[V16-D03]` | PRECISED BY V17 | `[V17-D06]`: distinguir inexistencia de fuente fiable en CT-49 y fallo runtime |
| `[V16-D08]` | PRECISED BY V17 | `[V17-D10]`: recursion, ciclos, Attribute y Dimension |

El resto conserva su alcance, salvo actualizaciones expresas de estado, version siguiente o referencias de esta
Proposal. La reconciliacion historica de V1–V15 se consulta en V16 §0; no se declara consenso retroactivo.

### 0.3 Politica runtime de third-party overrules (CT-49)

**Separacion causal.** Un reactor de terceros que ya escribio se refleja en la DB actual; una escritura posterior
es una mutacion/edicion futura. No es una señal de representacion externa ni un blocker runtime de VisualFootprint.
Esto no elimina la frescura, relectura y rollback existentes ni exime los registros de RackCad de G-M24 (§0.5).

CT-49 debe clasificar toda familia aplicable hallada en la superficie documentada de AutoCAD 2025 segun pueda
alterar geometria dibujada, transformacion o model-space extents / conservative occupancy. El estado final de cada
familia sera `FOOTPRINT_RELEVANT`, `FOOTPRINT_IRRELEVANT` o `UNKNOWN`, con evidencia y alcance por miembro.

| Familias minimas a investigar | Hipotesis que CT-49 debe resolver; no resultado ya demostrado |
|---|---|
| DrawableOverrule, GeometryOverrule, TransformOverrule | Potencialmente relevantes por dibujo, geometria/extents o transformacion |
| GripOverrule, OsnapOverrule, HighlightOverrule, PropertiesOverrule | Potencialmente irrelevantes, **solo si CT-49 lo demuestra** para la ocupacion que usa el contrato |
| ObjectOverrule, SubentityOverrule, VisibilityOverrule y equivalentes disponibles | Clasificacion obligatoria; no excluir por nombre, herencia o ausencia en la lista minima |

Autoridad preferida: equivalente a `Overrule.HasOverrule(subject, RXClass)` si la API 2025 la ofrece y CT-49
caracteriza su semantica. `subject` es el objeto consultado; `RXClass` identifica la **clase de overrule que se
consulta**, no se sustituye sin prueba por la clase del sujeto. CT-49 debe verificar herencia, filtros, resultados
por clase frente a objeto y conmutador global. Un resultado de clase potencialmente amplio no se vende como
precision por instancia. No se inspeccionan internals arbitrarios de plugins de terceros.

```text
familia demostrada FOOTPRINT_IRRELEVANT                  → no penalizacion por esa familia
overrule relevante demostrado NO APLICABLE               → no penalizacion por ese overrule
overrule FOOTPRINT_RELEVANT aplicable + cota conservadora → usar support demostrado
overrule FOOTPRINT_RELEVANT aplicable sin support         → VisualFootprint UNKNOWN
familia/aplicabilidad UNKNOWN                            → UNKNOWN donde no se pueda descartar efecto relevante
Overrule.Overruling == true, por si solo                  → NO significa EVERYTHING UNKNOWN
```

Si CT-49 demuestra que solo puede observarse un indicador global, documenta la limitacion y el alcance de su
fallo conservador. No permite asumir que ese indicador es la unica API por no haber investigado HasOverrule.
El fallback global puede afectar ampliamente a objetos posteriores y hacer fallar RACKMIRROR aun por un overrule
no relacionado que el host no permita distinguir. Se expone en O-1/L-34/M-35/R-58; una reduccion material exige V18.
Las observaciones consumidas quedan en FootprintInputFingerprint y se releen conforme a PRE-18; la autoridad debe
ser aplicable al contexto real del dibujo, sin presumir que clonar a una DB auxiliar conserva filtros por ObjectId.

Un objeto posterior con huella UNKNOWN sigue haciendo fallar ST-19 aunque parezca lejos. En huellas de la copia
se conserva la misma politica de ocupacion del modelo y el fallo del orden de plan cuando corresponda.

### 0.4 Discovery por modos, autoridades genericas e identidad (CT-49)

**Primero los modos, despues las señales.** CT-49 entrega un catalogo cerrado de modos persistentes de edicion
para el producto/vertical/API caracterizados. El metodo documenta las fuentes y secciones revisadas, los candidatos,
su inclusion o exclusion razonada y los huecos. Inspecciona sistematicamente:

1. Comandos documentados de edicion y sus estados persistentes.
2. Entornos y pestañas de edicion contextual; pares de apertura/cierre, fin, cancelacion y retorno al documento.
3. Long transactions y edicion in-place con working sets.
4. Edicion de fuentes asociativas y sus ciclos persistentes.
5. Block authoring/testing, incluidos documentos o ventanas temporales.
6. Catalogos de variables y API de sesion, para asignar detectores a los modos ya descubiertos y buscar omisiones.

| MODE minimo | Lifecycle minimo | Detector CANDIDATO; CT-49 debe probarlo entre comandos y en cierre/cancelacion |
|---|---|---|
| Edicion de referencia in-place | REFEDIT ↔ REFCLOSE | REFEDITNAME y/o long transaction + working set, con cobertura demostrada |
| Editor de bloques | BEDIT ↔ BCLOSE | BLOCKEDITOR y ambito de documento/database |
| Edicion de fuente de matriz asociativa | ARRAYEDIT Source ↔ ARRAYCLOSE | ARRAYEDITSTATE; distinguir Source de otras opciones |
| Prueba de bloques | BTESTBLOCK / block-test lifecycle | BLOCKTESTWINDOW y retorno al entorno de autoria |
| Otros modos descubiertos | Apertura, persistencia, cierre y cancelacion documentados | Detector dedicado o autoridad generica demostrada; sin ellos STOP |

Por cada modo: `MODE → reliable detector`, o `MODE → generic authority` con semantica explicita y cobertura
demostrada, o `UNSUPPORTED / NO RELIABLE DETECTOR ⇒ CT-49 STOP ⇒ Proposal V18`. Una señal de comando activo no
cubre por si sola el intervalo persistente entre comandos. No declarar cerrado el catalogo porque todas las
señales conocidas tienen una etiqueta. Cada detector sigue clasificado DETECTOR/IRRELEVANT/UNSUPPORTED, pero esa
tabla es consecuencia del catalogo de modos, no sustituto de el. Los modos minimos siguen BLOCKED.

**Autoridades genericas.** La ficha de cada una declara exactamente el predicado observado, document/database
al que corresponde, lectura fiable, estados de error, modos cubiertos y evidencia de cobertura:

- LongTransactionManager: prueba si existe una long transaction activa para el document/database consultado.
  No prueba por su nombre que toda forma de edicion persistente use una long transaction.
- WorkingSet authority: prueba pertenencia al working set activo de edicion in-place. No demuestra ausencia
  global de sesion porque un objeto arbitrario no pertenezca; CT-49 debe probar como localiza el conjunto y su ambito.
- Otra autoridad generica: mismo requisito, sin abstraer como «sesion activa» lo que la API no demuestra.

Si no se demuestra que modos cubre una autoridad requerida, STOP. No se permite el fallback «sin señal conocida,
seguro». La ejecucion usa el `EditingSessionAuthoritySet` finito resultante y no descubre nuevos modos.

**Host identity.** CT-49 identifica fuentes fiables para `product`, `vertical/host` y `major version/API family`,
con API o variable exacta, significado, ambito y casos que distingan hosts. Si no existe una fuente fiable durante
la caracterizacion, **STOP → Proposal V18**. No se sustituye por nombre de DLL, proceso o instalacion supuesto.
Runtime E12 solo existe despues de demostrar esa autoridad: si falla su lectura o el host/version actual queda
fuera del conjunto caracterizado. La ausencia de una fuente fiable no se difiere como un E12 permanente.

```text
P0 PASS ⇔ identidad fiable y caracterizada leida con exito
           AND todos los detectores requeridos leidos con exito
           AND todos los detectores BLOCKED inactivos
           AND las autoridades genericas requeridas satisfacen sus predicados de ausencia demostrados
fallo P0 → E12; misma causa en R6 → E10; al inicio de MUTATE → E11 + rollback
```

Se mantienen ST-20/PRE-19, la comprobacion de apertura parcial, la completitud relativa a la fuente y su orden
P0/R2/R3/R6/MUTATE. No cerrar sesiones, forzar cargas, modificar variables ni descubrir modos en runtime.

### 0.5 AutoCadApiCallCensus y registros de eventos (CT-50 / G-M24)

G-M24 conserva el lado A (productores/consumidores declarados y sus observaciones). Su lado B se cierra por
**AutoCadApiCallCensus**, no por enumerar familias conocidas. CT-50 produce y captura el censo inicial.

Universo: **todas las invocaciones de miembros de la API de AutoCAD alcanzables desde produccion de
RackCad.Plugin, caminos de materializacion y helpers/factories transitivamente utilizados**. Incluye constructores,
metodos, getters/setters, accesores de eventos, conversiones/operadores que invoquen API, inicializadores y llamadas
indirectas. Se incluyen callbacks y handlers alcanzables, delegates, wrappers de comando/COM y reflexion.
Una busqueda textual de nombres de familias es un fixture auxiliar; no demuestra el universo cerrado.

La captura mecanica identifica la superficie real de ensamblados API usada por el build, raiz y cadena de alcance,
sitio de llamada, miembro resuelto (tipo y firma/sobrecarga), clase de efecto, justificacion y enlace a productor,
read-set/footprint o exclusion. El metodo concreto se decide al caracterizar, sin añadir dependencias productivas.
Debe explicar como descubre cualquier miembro nuevo incluso si su familia no aparecia en V16. Una llamada indirecta
no resoluble no desaparece del censo: queda UNCLASSIFIED hasta justificar su tratamiento o produce STOP/RED.

| Clasificacion obligatoria por invocacion | Obligacion |
|---|---|
| READ_ONLY | Lectura demostrada; si aporta contexto/huella, enlazar sus observaciones consumidas; el nombre Get* no basta |
| DECLARED_MUTATOR | Efectos directos, internos o diferidos declarados y caracterizados; enlace a la autoridad y pruebas |
| EXCLUDED_WITH_REASON | Sitio permanece en el universo con razon verificable de exclusion del contrato vigilado; no exclusion por nombre de carpeta |
| UNCLASSIFIED | **G-M24 RED**; no publicacion productiva con esa guarda en verde |

El cierre mecanico exige igualdad de conjuntos entre sitios descubiertos y filas clasificadas: ningun sitio
sin fila, duplicado ambiguo, miembro sin resolver o fila obsoleta que encubra otro sitio. Se vuelve a generar
ante cambios; no depende del nombre actual de archivos/clases ni de hashes de texto. La evidencia de ejecucion
sigue identificandose por el SHA exacto. Clasificar READ_ONLY no exime el lado A ante un cambio de consumo.

**Fixtures obligatorios heredados de V16, sin convertirlos en limite del universo:** construccion/alta de
Entity, AppendEntity/AddNewlyCreatedDBObject, importacion/clonado (ReadDwgFile, Insert, Wblock,
WblockCloneObjects, DeepCloneObjects, Clone, GetTransformedCopy, Explode/ExplodeToOwnerSpace), altas de tablas
de simbolos, cabeceras/defaults de Database, GetSystemVariable/SetDatabaseDefaults, RecomputeDimensionBlock,
EvaluateHatch, GenerateLayout, RecordGraphicsModified, TransformBy, atributos, comandos/COM, reflexion,
aperturas ForWrite/UpgradeOpen/OpenCloseTransaction, setters de presentacion/registros/contexto,
SetSystemVariable, SynchronizeAttributes, LayerStateManager.Restore*, ReloadXrefs/ResolveXrefs/BindXrefs,
AssocManager.Evaluate*, Database.Audit, ResetBlock/ConvertToStaticBlock, AddOverrule/RemoveOverrule y helpers.

**Fixtures adicionales V17:** `Database.EvaluateFields`, `Field.Evaluate`, `DataLinkManager.Update*`,
`Table.UpdateDataLink`, `Database.UnloadXrefs`, `Database.DetachXref`, `Database.AttachXref`,
`Database.OverlayXref`, `LayoutManager.*`, `Database.UpdateExt`, registros de eventos de `Application` y
`DocumentCollection`. CT-50 resuelve las firmas existentes en API 2025 y documenta equivalentes o ausencias;
un nombre conceptual no afirma que todas sus sobrecargas existan. Los fixtures del censo inicial ausentes en
produccion se prueban en el futuro harness/guarda cuando su gate lo autorice; aqui no se crean pruebas.

**Registros/suscripciones de RackCad.** Todos los sitios de Database, Document, Editor, Application y
DocumentCollection que puedan mutar o programar escrituras diferidas se clasifican `DECLARED` o
`EXCLUDED_WITH_REASON`. DECLARED enlaza su entrada de API con efecto DECLARED_MUTATOR cuando registra un
handler mutador; una exclusion demuestra por que el handler no afecta al contrato. Se recorre transitivamente
el handler y el trabajo diferido; la suscripcion no se considera READ_ONLY solo porque aun no se ejecuto el
callback. Un sitio no clasificado ⇒ RED. Esta guarda de codigo no es una politica runtime para plugins terceros.

T-M75 conserva las violaciones anteriores y añade explicitamente una llamada **arbitraria** a un miembro de
AutoCAD ajeno a las familias enumeradas: UNCLASSIFIED ⇒ RED. Una guarda verde solo en fixtures enumerativos falla
este requisito. El censo inicial no se sustituye por el anterior resultado indicativo «sin sitios».

### 0.6 Campos nested/cyclic y frontera causal (CT-49)

La clasificacion se aplica recursivamente al grafo de dependencias de cada campo. En una envolvente STATE,
las hojas edit-dependent quedan FIXED al valor actual; las hojas state-dependent pueden variar dentro de los
estados admitidos. No congelar un campo anidado completo que contenga hojas de ambos tipos. `DataLink` conserva
su excepcion explicita STATE aunque se hayan actualizado datos externos. Causa EDIT tiene precedencia sobre
la reevaluacion del campo. No se adivina una dependencia no clasificable.

Nested field: recorrer y clasificar hijos/hojas transitivos, conservando causas y correlaciones necesarias
para la cota. Cycle: detectar el ciclo; si no existe una **finite conservative bound** demostrada para los
resultados admitidos, **UNKNOWN**. La terminacion del recorrido no es por si sola una cota del resultado.

- `Area(objeto) + Date`: area fija; fecha variable.
- `Length(objeto) + DataLink`: longitud fija; DataLink variable.
- Campo anidado con Attribute + entrada STATE: valor/contenido del atributo fijo por defecto (su mutacion es EDIT),
  entrada STATE variable; si el atributo contiene a su vez un campo, clasificar recursivamente sus hojas.
- Dimension measured value: cambio por geometry edit ⇒ EDIT; variacion de apariencia/valor por estado,
  estilo o sysvar explicitamente admitido ⇒ STATE **solo donde CT-49 lo caracterice**. No convierte toda edicion
  de estilo en STATE ni toda reevaluacion en EDIT. Sin cota de los estados admitidos ⇒ UNKNOWN.

La garantia XREF no cambia: contenido cargado actual + completitud, sin abrir archivos externos ni comparar
identidades futuras. Archivo reemplazado sin reload no cambia la autoridad cargada; reload con contenido cambiado
es EDIT futuro. Un XREF unresolved ahora es UNKNOWN ahora.

### 0.7 O-1 y riesgos: textos vinculantes de L-34, M-35, R-57 y R-58

**L-34 / M-35 (adicion a sus limitaciones conservadas).** Un overrule footprint-relevant de terceros aplicable a
objetos posteriores, cuya ocupacion conservadora no pueda demostrarse, puede hacer fallar RACKMIRROR aunque el
objeto parezca lejano. CT-49 prefiere aplicabilidad por sujeto/clase; si demuestra que solo hay autoridad global,
el fallo puede ser amplio, incluso por actividad no relacionada que no pueda distinguirse. Familias demostradas
irrelevantes y overrules demostrados no aplicables no penalizan cuando la autoridad permite distinguirlos.
Los reactores de terceros no son blockers de representacion. L-37 conserva STATE/EDIT y remite aqui para overrules.

L-34 y M-35 tambien exponen: modos persistentes bloqueantes; dependencia de un catalogo cerrado con mapping
modo→detector; cobertura generica demostrada; host/version fuera del conjunto o lectura runtime fallida ⇒ fallo;
modo sin detector fiable, cobertura generica no demostrada o fuente de identidad ausente en CT-49 ⇒ STOP antes de
implementar. No prometer que G3 vaya a demostrar esas autoridades.

**R-57.** CT-49 podria no lograr el catalogo de modos, su mapping, cobertura generica o fuente fiable de producto,
vertical/host y version/API. En ese caso STOP y Proposal V18; no implementar un comando que falle siempre E12 por
una autoridad inexistente. Con autoridad establecida, host no caracterizado o lectura fallida producen el fallo
runtime previsto; no se flexibiliza como aviso.

**R-58.** Un overrule footprint-relevant aplicable sin support conservador puede hacer fallar el comando por la
huella de un objeto posterior. CT-49 debe medir relevancia, aplicabilidad y alcance real; solo si demuestra que
dispone de autoridad global puede ampliar el fallo, exponiendolo en O-1/L-34/M-35. No inferir EVERYTHING UNKNOWN
de Overruling por si solo ni incluir third-party reactors. Reduccion material de alcance ⇒ Proposal V18 y O-1 se
reevalua. **O-1 sigue PENDING y no se pide en este gate.**

### 0.8 Casos futuros obligatorios (CT-49, CT-50, T-M73, T-M75, G3)

| Grupo | Casos y resultado exigido |
|---|---|
| Modos | Catalogo cerrado construido desde comandos/entornos/lifecycles; cada modo mapeado; persistente sin detector ⇒ CT-49 STOP; generic detector con cobertura demostrada; host identity source ausente ⇒ CT-49 STOP; host fuera del conjunto y lectura fallida ⇒ E12 en P0; minimos REFEDIT, BEDIT, ARRAYEDIT Source, BTESTBLOCK activos/inactivos y entre comandos |
| Overrules | Drawable/Geometry/Transform relevante aplicable sin support ⇒ UNKNOWN; Grip/Osnap/Highlight demostrado irrelevante ⇒ no UNKNOWN por esa causa; Properties caracterizado; overrule no relacionado y distinguible ⇒ sin efecto; filtro por sujeto y clase; fallback global solo si es la unica autoridad demostrada y con alcance declarado |
| G-M24 / T-M75 | EvaluateFields unclassified ⇒ RED; Field.Evaluate; DataLink update API unclassified ⇒ RED; XREF mutation API unclassified ⇒ RED; LayoutManager y UpdateExt; Application event registration unclassified ⇒ RED; DocumentCollection; handler que programa escritura diferida; invocacion arbitraria no enumerada a API AutoCAD unclassified ⇒ RED; conservar clon, lectura de cabecera, mutacion de presentacion, mutador interno y overrule/reactor de RackCad |
| Fields | Nested mixto con hojas EDIT fijas; cyclic sin cota finita ⇒ UNKNOWN; ciclo con cota solo si demostrada; Attribute + state input; Dimension geometry edit frente a estado/style/sysvar admitido y caracterizado; conservar Area+Date y Length+DataLink |
| XREF | loaded complete; demand-loaded incomplete ⇒ UNKNOWN; unresolved ⇒ UNKNOWN; external file replaced without reload usa contenido cargado; reload changed content ⇒ EDIT; conservar otra ruta al mismo contenido cargado |

Son obligaciones de caracterizacion y pruebas en sus gates correspondientes, **no resultados**. CT-49 y CT-50
se ejecutaran en G3 fuera de src; las guardas productivas y T-M75 se implementaran en sus gates posteriores.
**G3 NOT OPEN**. Cualquier contradiccion material frente a V17 ⇒ **Proposal V18**.

### 0.9 Preflight y paralelas actuales

Fetch con prune antes de escribir. Entrada en el worktree principal `main`, limpio; trabajo efectuado en el
worktree existente `feature-rackmirror-espejo-semantico`, rama `feature/rackmirror-espejo-semantico`.
HEAD de entrada = origin/I-52 = V16 esperada. Sin stash, modificaciones ni operaciones Git incompletas en I-52.
Cinco worktrees: principal, I-49, I-52, I-55 e I-56; no se crea ni elimina ninguno. Los SHAs exactos se entregan
en el informe de publicacion y cuerpo del commit; no se copian nuevos conteos de suites a este documento.

| Ref / iniciativa | Estado verificado frente al relevo | Materialidad y consecuencia |
|---|---|---|
| main | Sin avance | Sin nuevas autoridades que reconciliar en este gate; rebase sigue posterior al consenso |
| I-52 | V16 exacta, CI push success | Continuacion permitida para V17 documental |
| I-49 | A3-R3 registra consenso EXACT sobre A3-R2: Coordinator AGREED WITH A3-R2; Architect AGREED WITH A3-R2; replacement ADR REQUIRED; Owner PENDING; nuevo freeze PENDING; G7/G8 BLOCKED | Cambio solo en decisions/I-49; contrato I-52 NON-MATERIAL, coordinacion MATERIAL. RS-3 = PENDING I-49 FINAL AUTHORITY; I-52 FREEZE = BLOCKED |
| I-55 | Proposal V4 y paquetes sin avance; Coordinator REVIEW REQUIRED; Architect formal PENDING; Owner PENDING; Consensus NOT REACHED; sin produccion | Contract impact NON-MATERIAL; coordination HIGH / ACTIVE. No adoptar diferencias X-* unilateralmente |
| I-56 | Review de V2 sin avance: CHANGES REQUIRED — PROPOSAL V3; Workflow V2 NOT EFFECTIVE | NON-MATERIAL; I-52 grandfathered; ninguna Proposal de I-56 aplica |

I-49 ya contiene produccion de su nucleo hasta G6; **el avance observado desde A3-R2 no cambia produccion**.
I-55 e I-56 siguen documentales. No confundir «sin produccion nueva en el avance» con «I-49 sin produccion».
No importar semantica intermedia de A3-R2, ni presentar su consenso tecnico como autoridad final de RS-3.
Se requieren V6+A1+A2+A3, ADR sucesor aceptado, nuevo Consensus Freeze y estado de implementacion vigentes.

ADR publicados: main conserva hasta 0035 y 0037/0039; 0036 propuesto solo en I-52; I-49 tiene 0038/0040
reemplazados y 0041 aceptado; I-55 tiene 0042 propuesto. No se encontro numero sucesor publicado/reservado para
I-49 ni colision con 0036. La asignacion del sucesor queda en I-49, no en este gate.

### 0.10 Proceso y referencias de revision

```text
Coordinator + Architect agree V17 exacta
→ technical consensus
→ rebase CURRENT main
→ mandatory I-52/I-55/I-49 reconciliation (propiedad y ubicacion de autoridades, sin duplicacion)
→ resolve current I-55/X-* formal state
→ require FINAL I-49 authority para RS-3
→ freeze exact SHA
→ exact-SHA re-check
→ O-1
→ G3
   material contradiction → Proposal V18 (O-1 se reevalua)
   sin contradiccion material y sin filas G3_PENDING → Owner accepts ADR-0036 → G4
```

I-52 sigue grandfathered. Antes de cada transicion se relee la autoridad vigente y sus reglas de transicion.
Este gate no rebasea, no congela, no pide O-1, no acepta ADR-0036 ni declara consenso.

Fuentes documentales externas consultadas, **no evidencia de ejecucion de CT-49/CT-50**:

- [Autodesk, Overrule Methods (2024)](https://help.autodesk.com/cloudhelp/2024/ENU/OARX-ManagedRefGuide/files/OARX-ManagedRefGuide-__MEMBERTYPE_Methods_Autodesk_AutoCAD_Runtime_Overrule.html): candidato HasOverrule; disponibilidad y filtros en 2025 por verificar.
- [Autodesk, hasOverrule (2019)](https://help.autodesk.com/cloudhelp/2019/ENU/OARX-RefGuide/files/OREF-AcRxOverrule__hasOverrule_AcRxObject__AcRxClass_.html): distingue sujeto y clase de overrule; no demuestra precision de filtros en .NET 2025.
- [Autodesk, Specialized Overrule Classes (2021)](https://help.autodesk.com/cloudhelp/2021/ENU/OARX-DevGuide/files/GUID-68031E96-D93C-408F-AD1C-1F2586C8208D.htm): familias como entrada a investigar, no clasificacion final de footprint.
- [Autodesk, ARRAYEDITSTATE (2025)](https://help.autodesk.com/cloudhelp/2025/ENU/AutoCAD-Core/files/GUID-E71DAD51-8377-4B32-B33D-095E45672F18.htm): señal de solo lectura del estado de edicion de fuentes; no cierra el catalogo de modos.

El paquete [Architect Review V17](I-52-architect-review-package-v17.md) define el objeto exacto y el checklist
autonomo. El registro [decisions/I-52](../automation/decisions/I-52.md) §§98–103 conserva la entrada y el estado.
...
Registro: `docs/automation/decisions/I-52.md` §4. Vinculan V17; **no** son consenso final.
...
|---|---|---|---|
| **O-1** | **Alcance del primer corte.** El Owner acepta la **envolvente maxima de alcance** de §1.3 (L-01..L-37), su politica fail-closed, la **seleccion todo-o-nada** y la **dependencia de la biblioteca efectiva**. O-1 **no** promete que G3 verifique todos los candidatos y **no** acepta como resultado universal la inspeccion de una biblioteca concreta (§1.4). Si G3 reduce materialmente la envolvente ⇒ Proposal V18 y O-1 se reevalua | envolvente de §1.3 | **pendiente**; se pide **despues del freeze tecnico** y **antes de G3**; **no** se pide en este gate |
...
| **O-4** | **ADR-0036** | `propuesto` | se pide **despues de G3** si G3 no contradice materialmente V17; si la contradice ⇒ Proposal V18; **precondicion de G4** |
...
| Campo | Valor | Papel |
|---|---|---|
| SHA-256 del contenido binario | `b4ca2248db9c3d72487ac8b5b1e5510cdd8aba231ab340541d91bebca2d560e8` (re-verificado en los preflights de V7, V8, V9, V10, V11, V12, V13, V14, V15 y V17) | **identidad de la evidencia** |
...
quitan, en esta medicion, ninguna de las piezas estructurales medidas; las de V9, V10, V11, V12, V13, V14, V15 y V17
...
equivalencia de la fachada: **STOP → Proposal V18**. No se duplica la agrupacion en un segundo planificador. Las guardas
...
Caso A — un fondo, valores positivos. Claro i sin medio frente.
  ...
  V = 1 ⇒ W = max(70, 76 + 3)  = 79 < 80: la fila de N1 se apila desde la izquierda en el original y en la copia.
    V17: Dep(i) verdadero; W_lb(i) = max(70, −∞) = 70 < 80 ⇒ ¬DEP-ROW ⇒ S-17d UNKNOWN ⇒ FAIL_CLOSED;
...
Caso B — dos fondos, sin overrides.
  ...
  V = 4 ⇒ W = 92 ≥ 88;  V = 1 ⇒ W = 83 < 88: la frontal del fondo 1 desborda.
    V17: Dep(i) verdadero; W_lb(i) = −∞ ⇒ ¬DEP-ROW ⇒ S-17d UNKNOWN ⇒ FAIL_CLOSED (y S-26 UNKNOWN).
...
- **CT-37 (C:V6-10, incondicional; Core, `[V7-D18]`):** diferencial con dos o mas estados del registro por **cada**
  ...
  DEP-09/DEP-10a..c. Un contraejemplo no previsto por V-DEP contradice V17 ⇒ **STOP → Proposal V18**.
...
## 7. Matriz de representabilidad V17
...
EvidenceStatus               (de donde sale la clasificacion)
  ...
  G3_VERIFIED       confirmada por la caracterizacion de G3 (ninguna fila en V17)
...
envolvente de O-1), el ADR, una regla de reflexion o la arquitectura ⇒ **Proposal V18**. T-M47 lo hace ejecutable desde
G5.
...
Application, fuera del comando. **Su ubicacion no la fija V17**: puede quedar junto al contrato de cada kind o en un
...
Marcas de V12 a V17 en esta seccion: `[V12-D07]` (regla de entorno tambien en la copia), `[V12-D09]` (censo global de
...
Regla
  ...
  G-M24 protege a los productores con dos lados ([V11-D08], [V12-D09]):
    ...
    B) AutoCadApiCallCensus (§0.5): TODAS las invocaciones de miembros de API AutoCAD alcanzables
       desde produccion RackCad.Plugin, materializacion y helpers/factories transitivos, incluidos
       accesores y callbacks; READ_ONLY / DECLARED_MUTATOR / EXCLUDED_WITH_REASON;
       UNCLASSIFIED o alcance indirecto sin resolver ⇒ RED; CT-50 captura el censo inicial.
       Igualdad mecanica entre sitios descubiertos y clasificados, sin huecos ni filas que oculten sitios.
       Las familias siguientes son FIXTURES obligatorios, NO mecanismo de cierre:
         ...
         registro de overrule o reactor ([V16-D06]): DrawableOverrule · ObjectOverrule · TransformOverrule · demas
           ...
           Document, Editor, Application o DocumentCollection a comandos/eventos con escrituras diferidas;
           cada registro RackCad DECLARED o EXCLUDED_WITH_REASON, handlers transitivos incluidos
         adicionales V17: Database.EvaluateFields · Field.Evaluate · DataLinkManager.Update* ·
           Table.UpdateDataLink · Database.UnloadXrefs · DetachXref · AttachXref · OverlayXref ·
           LayoutManager.* · Database.UpdateExt
         delegacion en helpers o factorias
       cada invocacion READ_ONLY / DECLARED_MUTATOR / EXCLUDED_WITH_REASON; UNCLASSIFIED ⇒ RED; no depende
...
- No crea obligacion de tocar los drawers existentes (§20.3); G-M8 y G-M11 no cambian, y G-M24 vigila, sin modificarlos,
  a los productores declarados y, con AutoCadApiCallCensus (§0.5), toda invocacion de API, incluidos sitios de productor, consumidor o
...
`AutoCadApiCallCensus` sustituye a ProducerSiteCensus como cierre del lado B de G-M24 (§0.5, §8.7);
las familias son fixtures y toda invocacion API alcanzable queda clasificada o RED. `DatabaseVisibilityCompleteness`
   ...
   **distinta** de `GeometrySymmetryResult`: `GeometrySymmetryResult` demuestra **simetria**; `VisualFootprintResult`
   ...
   - **`ModelSpaceFootprintPolicy` (`[V11-D02]`, `[V12-D01]`, `[V12-D02]`, `[V13-D01]`..`[V13-D05]`).** Autoridad
     ...
     ModelSpaceFootprintPolicy (nombre ilustrativo; no es schema persistido)
       ...
       UNKNOWN:
         ...
         overrules        §0.3: familia relevante + aplicabilidad sujeto/clase + sin support ⇒ UNKNOWN;
                          familia irrelevante o no aplicable demostradas ⇒ sin penalizacion;
                          fallback global solo si CT-49 lo demuestra; reactores de terceros fuera
                          sin inspeccionar plugins de terceros ([V17-D01]..[V17-D03])
   ...
   - **Completitud de la base de datos y de la enumeracion (`[V13-D01]`, `[V13-D02]`, `[V13-D04]`, `[V14-D01]`,
     ...
     **autoridad observable**, el `EditingSessionAuthoritySet` (nombre conceptual): un conjunto finito de detectores que
     CT-49 establece a partir del catalogo cerrado de MODOS persistentes y su mapping a detectores
     fiables (§0.4): comandos, estados persistentes, entornos/pestañas contextuales, pares open/close,
     long transactions, fuentes asociativas y block authoring/testing; primero modos, despues señales.
     Cada modo tiene detector fiable dedicado o autoridad generica con predicado, ambito y cobertura
     demostrada. Sin ellos, o sin fuente fiable de product/vertical-host/major-API, CT-49 STOP ⇒ V18.
     LongTransactionManager prueba existencia de long transaction en document/database; working set
     prueba pertenencia al conjunto activo in-place, no ausencia general. Active-command state no basta.
     Las señales REFEDITNAME, BLOCKEDITOR, BLOCKTESTWINDOW y ARRAYEDITSTATE son candidatas, pendientes
     de caracterizar; cada señal se clasifica DETECTOR/IRRELEVANT/UNSUPPORTED despues del catalogo.
     La ejecucion **no** descubre modos desconocidos: el resultado es **PASS** si
     ...
     contradiccion material ⇒ Proposal V18; se prohiben las dos lecturas degeneradas (dejar pasar lo no inventariado y
     ...
     otra estructura; reclasificar como seguro un estado del inventario minimo exige Proposal V18. Un fallo ⇒ E12, y los
   ...
   - **Campos (`[V12-D06]`, `[V15-D04]`, `[V16-D08]`).** Si la ocupacion de modelo de un objeto depende de la evaluacion
     ...
     especial explicita: datos externos cambiados + refresco = ESTADO. **Recursion (`[V17-D10]`, §0.6):** clasificar campos nested hasta sus hojas; en ciclos, sin finite
     conservative bound ⇒ UNKNOWN. Attribute value/content mutation por defecto es EDIT; Dimension measured
     value por geometry edit es EDIT, y apariencia/valor por estado/style/sysvar admitido es STATE solo donde
     se caracterice. **Dependencias mixtas (`[V16-D08]` precisada por V17):** en un
   ...
   - **Overrules de terceros (`[V17-D01]`..`[V17-D03]`).** Rige §0.3: solo overrules
     FOOTPRINT_RELEVANT aplicables al sujeto/clase y sin support conservador dejan la huella UNKNOWN;
     una familia o aplicabilidad desconocida falla cerrado donde no pueda descartarse efecto relevante.
     CT-49 clasifica Drawable/Geometry/Transform, Grip/Osnap/Highlight/Properties y equivalentes;
     demuestra la semantica de HasOverrule(subject, RXClass de overrule) o equivalente. Familia demostrada
     irrelevante y overrule demostrado no aplicable no penalizan. Solo una autoridad global demostrada
     permite ampliar conservadoramente el fallo, expuesto en L-34/M-35/R-58; Overruling por si solo no
     significa EVERYTHING UNKNOWN. Un reactor de terceros no es una señal de representacion: su escritura
     pasada esta en la DB actual y su escritura futura es EDIT. Sin inspeccionar internals de plugins.
...
6. **Politica visual-geometrica.**
   ...
   **6.1 CLOSED VARIANT POLICY: clase + variantes soportadas (`[V8-D01]`..`[V8-D05]`).** La allowlist ya no es solo por
   ...
   - **Completitud (G3, `[V9-D08]`).** CT-36 enumera, por clase soportada y con el metodo de inventario cerrado del
     ...
     reduce materialmente la envolvente ⇒ Proposal V18.
   ...
   **6.2 SYMBOLIC VISUAL SOURCES tipadas (`[V7-D01]`..`[V7-D03]`, `[V7-D27]`, `[V8-D06]`..`[V8-D09]`, `[V8-D11]`).** La
   ...
   - **`Explicit` tipado (`[V8-D06]`).** `Explicit` conserva el **metodo** y el **valor**, nunca solo el valor resuelto:
     ...
     - `LinetypeScale`: `double` por igualdad exacta del valor almacenado (V17 no introduce tolerancia; CT-36 registra
   ...
   **visualmente material**:
   ...
   Si no puede demostrarse ⇒ X-22 / `FAIL_CLOSED`. V17 no define una teoria global de DRAWORDER para objetos que no se
   ...
   **6.6 Orden visual de plan entre instancias de pieza (`[V8-D12]`, `[V9-D03]`).** 6.5 controla el orden **dentro** de
   ...
   - V-VIEW-ALL deja de tratar esos pares como un multiconjunto puro (§6.6, §11.1). V17 **no** crea una teoria global de
...
8. **Canonicalizacion conservadora y verificacion (`[V7-D10]`..`[V7-D12]`, `[V8-D02]`, `[V8-D04]`).** Antes de comparar,
   ...
   `GeometryTolerance.Length` (y `GeometryTolerance.Angle` donde aplique). V17 no introduce una tolerancia nueva: CT-36
...
14. **Contrato de caracterizacion en AutoCAD 2025 (CT-36).** G3 **no** añade la sonda productiva a `src/`: demuestra su
    ...
    **STOP → Proposal V18**. La sonda productiva nace en el Plugin en el gate en que la necesite la autoridad de planes
...
- Cada anclaje asimetrico produce una fila `UNKNOWN` con `FAIL_CLOSED` o una regla explicita aprobada por el Owner.
  Nunca un parche silencioso: una contradiccion material con V17 abre **Proposal V18**.
...
| **G-M24** | Guarda durable de productores de contexto con dos lados: (A) productores y consumidores declarados con sus observaciones, defaults, tipos y resolucion; cambios ⇒ RED hasta actualizar CT-50, MaterializationContextReadSet, FootprintInputFingerprint y pruebas; (B) **AutoCadApiCallCensus** mecanicamente cerrado (§0.5), todas las invocaciones API alcanzables desde produccion Plugin, materializacion y helpers/factories transitivos, con READ_ONLY / DECLARED_MUTATOR / EXCLUDED_WITH_REASON; UNCLASSIFIED ⇒ RED. Familias V17 y fixtures V17 obligatorios, nunca mecanismo de cierre; registros de Database/Document/Editor/Application/DocumentCollection con handlers mutadores o diferidos DECLARED o EXCLUDED_WITH_REASON; sin sitios omitidos, llamadas indirectas no resueltas ni exclusiones sin motivo. T-M75 incluye una llamada arbitraria no enumerada; CT-50 captura el censo inicial. Sin dependencia de nombres actuales de archivos/clases o hashes. |
...
### 14.1 Secuencia normativa (vigente en V17; §0.10)

```text
Coordinador + Arquitecto de acuerdo sobre V17 (misma version, exact-SHA) = consenso tecnico
...
→ reconciliacion OBLIGATORIA entre iniciativas          (I-52 ↔ I-55 ↔ I-49, con las ultimas entradas X-*
                                                          ...
                                                          CROSS-INITIATIVE RECONCILIATION en V17: taxonomia de
...
→ estado formal de I-55 resuelto                          (revision formal de su Proposal vigente, hoy V4
                                                          ...
                                                          [V16-D14])
→ autoridad FINAL de I-49 disponible para RS-3            (V6 + A1 + A2 + A3-R2 con consenso exacto (A3-R3), pendiente de autoridad final, ADR de reemplazo
...
→ G3 characterization                                    (ADR-0036 NO es precondicion; sonda solo fuera de src/;
     ...
     si G3 contradice materialmente V17 o reduce materialmente la envolvente → Proposal V18 (y O-1 se reevalua)
...
### 15.1 main y paralelas: preflight V17

El estado ACTUAL es §0.9. I-49 A3-R2 ya tiene consenso tecnico exacto registrado en A3-R3;
ADR sucesor, Owner y nuevo freeze siguen pendientes: RS-3 PENDING e I-52 FREEZE BLOCKED.
I-55 e I-56 no avanzaron frente al relevo. No hay produccion nueva en el avance observado.
Los registros que siguen conservan los anclajes de codigo de V17; sus estados historicos no sustituyen §0.9.

#### Anclajes heredados de codigo y biblioteca

El preflight historico completo y los desplazamientos de citas por I-53S, I-54 e I-53D se conservan en
[V16 §15.1](I-52-proposal-v16.md). No son el estado actual de las paralelas: para eso rige §0.9.
Las citas del modelo conservan su ancla productiva original; se re-anclaran al rebase posterior al consenso.
La evidencia de biblioteca de §1.4 sigue indicativa y no fue reproducida en este gate documental.
...
| **I-49**: A3-R2 con consenso tecnico EXACT registrado en A3-R3 (§0.9), nucleo G6 cerrado; G7/G8 BLOCKED; ADR sucesor completo, Owner y nuevo freeze pendientes | ProjectVariables, expression, PlanReadSet, dominio del consumidor, guardas y fundacion multi-rack compartida | Contrato I-52 NON-MATERIAL; coordinacion MATERIAL. No adoptar semantica intermedia. Antes de tocar RackDuplicationPlan, coordinar I-49; T-M19. CT-46/G-M18 releen guardas. RS-3 = PENDING I-49 FINAL AUTHORITY e I-52 FREEZE = BLOCKED hasta releer V6+A1+A2+A3, ADR sucesor aceptado, freeze y estado de implementacion. Cancelacion/abandono no desbloquea automaticamente (R-55). |
...
- **I-49:** si integra, re-medir la cota autoritativa de V-DEP (§6.5.5), la autoridad del read-set (§9.2.1) y sus
  ...
  archivos de I-52. Estado actual: A3-R2 cuenta con consenso tecnico EXACT de Coordinador y Arquitecto
  registrado en A3-R3 (§0.9); siguen pendientes el ADR sucesor completo, Owner y nuevo Consensus Freeze.
  No se adopta semantica intermedia de A3-R2 en I-52. **Antes del freeze de I-52** se relee obligatoriamente
...
- **I-55 (`feature/creacion-de-vistas` @ `8068368`, View Placement & Projection, Proposal V4 en revision con Arquitecto
  ...
  V17 y al rebase, con X-1..X-8 como entrada vinculante (§15.4), que registra la propiedad de las autoridades
  compartidas que V17 conserva como provisionales —taxonomia de tipo de vista, codec semantico de `View`/`Section`,
...
freeze, nunca de forma unilateral. V17 **no** adopta todavia los requisitos del lado de I-52 ni congela namespace,
...
- Archivo: `docs/adr/0036-rackmirror-espejo-semantico-por-copia.md`, estado **`propuesto`**, con fila en el indice de la
  rama. Actualizado en este gate con las correcciones de V17.
...
3. **Otros numeros observados:** ADR-0035 es de I-50 (aceptado e integrado en main). ADR-0037 lo publico I-53 en
   ...
   **aceptado** en `5efaf7e` y ahora esta **en main** por el merge `1b091be`. ADR-0038 lo publico I-49 en `a160560`
   ...
   antes de Insertar. I-49 A3-R2 tiene consenso tecnico exacto registrado en A3-R3; su ADR sucesor completo,
   aceptacion del Owner y nuevo freeze siguen pendientes (§0.9). No hay numero sucesor publicado/reservado
   en el preflight V17, ni colision con 0036; la asignacion corresponde a I-49. I-56 no publica ADR nuevo.
...
no contradice materialmente V17, y **es precondicion de G4**. Mientras tanto el ADR sigue `propuesto` y puede corregirse
si G3 abre Proposal V18. `docs/adr/README.md` no cambia en este gate: la fila de 0036 de la rama sigue correcta, y la
...
| R-12 | La auditoria de anclajes (CT-17) puede degradar muchas filas `R` + `G3_PENDING` a `UK` | Regla de cierre de G3; Proposal V18 si el cambio es material; nunca parche silencioso |
...
| **R-29** | La canonicalizacion puede quedar ambigua en piezas con geometria solapada o degenerada | `UNKNOWN` ante ambiguedad; tasa medida en CT-36 y CT-47; ambiguedad material ⇒ Proposal V18 |
| **R-30** | Con la biblioteca inspeccionada, gran parte de Dinamico y Push Back fallaria cerrado por los separadores de planta (§1.4) | evidencia indicativa; G3 la confirma o refuta; si reduce materialmente la envolvente ⇒ Proposal V18 y nueva O-1; la equivariancia de builders queda fuera de I-52 |
...
| **R-33** | La base auxiliar puede no ofrecer un punto de observacion soportado equivalente al materializador | X-17a; si afecta a kinds enteros ⇒ Proposal V18 o reduccion de alcance |
...
| **R-35** | El orden visual de plan (`[V8-D12]`, `[V9-D03]`) puede dejar fuera kinds o vistas: bajo `μ_k` se invierten los pares de una misma pasada y cualquier par invertido con huellas superpuestas de forma material, o con huella `UNKNOWN`, falla (X-22) | CT-48 enumera los pares invertidos por kind y vista, mide su superposicion y registra la reduccion de alcance; hoy el frontal Selectivo emite postes antes que largueros (§11.3 punto 6.6); reduccion material ⇒ Proposal V18 y nueva O-1 |
...
| **R-38** | AutoCAD 2025 puede no permitir reproducir en una base auxiliar el contexto del dibujo (por ejemplo, `PSTYLEMODE` con estilos de trazado con nombre) | `UNKNOWN` ⇒ X-17a en las piezas con cambio de mano afectadas; CT-36 con dibujos STB y CTB; si afecta a kinds enteros ⇒ Proposal V18 |
...
| **R-57** | CT-49 podria no cerrar el catalogo de modos, mapping modo→detector, cobertura de autoridades genericas o fuente fiable de product/vertical-host/major-API (§0.4) | STOP ⇒ Proposal V18; no implementar E12 permanente por autoridad inexistente. Con fuente establecida, host fuera del conjunto o lectura runtime fallida ⇒ E12 en P0, E10 en R6 y E11/rollback en MUTATE; L-34/M-35; §0.7 |
| **R-58** | Overrule footprint-relevant aplicable a objetos posteriores sin ocupacion conservadora demostrada puede hacer fallar RACKMIRROR (§0.3) | CT-49 caracteriza relevancia y aplicabilidad por sujeto/clase; solo autoridad global demostrada permite fallo amplio, expuesto en O-1/L-34/M-35; sin third-party reactors ni EVERYTHING UNKNOWN por Overruling aislado; reduccion material ⇒ V18; §0.7 |

---

## 18. Desacuerdos y decisiones

§0.1–§0.2 es la matriz vigente: AR16-01..03 y LOW se resuelven documentalmente por la orden V17-01..14.
OPEN MATERIAL = NONE para revision; no es consenso ni resultado de G3. Las alternativas y decisiones
historicas se conservan en V16 §18 y decisions/I-52 §§1–97; quedan sustituidas donde §0 lo identifica.

No hay decision nueva del Owner. O-1 PENDING; ADR-0036 PROPOSED; G3 NOT OPEN.
Limitaciones pendientes de caracterizar: aplicabilidad y familia de overrule; catalogo de modos y
cobertura generica; identidad fiable del host; censo mecanicamente cerrado; cotas de campos nested/cyclic.
Sin evidencia suficiente se cumple STOP/UNKNOWN/RED segun §0, nunca se inventa soporte.

La evidencia indicativa heredada de biblioteca y los censos historicos no acreditan CT-49 ni CT-50.
Toda contradiccion material ⇒ Proposal V18. I-49 conserva RS-3 pendiente pese al consenso tecnico A3-R2.

---

## 19. Condiciones de parada

V17 añade: modo persistente sin detector fiable, autoridad generica sin cobertura demostrada o fuente de
host identity ausente ⇒ CT-49 STOP → Proposal V18; invocacion API AutoCAD o registro de eventos sin clasificar
⇒ G-M24 RED; ciclo de campos sin cota finita ⇒ UNKNOWN. Politica de terceros exclusivamente §0.3, sin
reactores como blockers de representacion. No abrir G3 en este gate ni declarar consenso/ADR aceptado.
...
- G3 demuestra que la sonda por estado no es viable en `acad.exe` / AutoCAD 2025, que no tiene paridad con el
  ...
  consumo no puede determinarse, o que la canonicalizacion es materialmente ambigua: **STOP → Proposal V18** o reduccion
  de alcance.
...
- Se intenta ejecutar ST-19 o clasificar huellas con la base de datos abierta parcialmente o sin completitud demostrada,
  ...
  invocacion de API AutoCAD sin clasificar en AutoCadApiCallCensus: **prohibido** (G-M23, G-M24,
...
- Se intenta ejecutar RACKMIRROR con ARRAYEDIT Source, la ventana de prueba de bloques, una transaccion larga u otro
  ...
  del inventario minimo sin Proposal V18, integrar un sitio de escritura o mutacion de objetos o contexto existentes sin
...
- Se intenta descubrir modos de edicion desconocidos en ejecucion, tratar una lectura fallida o no clasificable de un
  ...
  sin el catalogo cerrado de modos, mapping, cobertura generica e identidad fiable de CT-49 (§0.4), dejar pasar un modo relevante sin detector fiable en lugar de
  detenerse, integrar un mutador interno de AutoCAD o un registro de overrule o de reactor sin clasificar, calcular la
  huella de un objeto que un overrule footprint-relevant aplicable puede alterar sin equivalencia u ocupacion conservadora
...
- Un tipo de I-52 aparece en `RackCad.Application.Systems.Shared` o un archivo de I-52 viola una guarda de texto vigente:
  **RED** (G-M14, G-M18).
- Aparece un parametro dinamico con semantica de lado sin regla: fail-closed y registro para Proposal V18.
...
productores declarados y censo cerrado AutoCadApiCallCensus de todas las invocaciones, con familias como fixtures, `[V12-D09]`,
...
La secuencia vigente completa es §0.10; la revision previa es V16 CHANGES REQUIRED — PROPOSAL V17.
Este documento consolida V17. G3 nunca se ha abierto.


```text
G0 = ACCEPTED        G1 = ACCEPTED (Discovery)
G2 = V17 EN REVISION (este documento + ADR-0036 propuesto actualizado + docs/automation/decisions/I-52.md)
     ...
     historial
     revision de V16: Architect: CHANGES REQUIRED — PROPOSAL V17
O-1 = PENDING        (envolvente de §1.3, L-01..L-37; se pide despues del freeze tecnico y antes de G3; no en este gate)
G3 = NOT OPEN        (requiere consenso sobre V17, rebase sobre el main vigente, reconciliacion con I-55 e I-49 con
