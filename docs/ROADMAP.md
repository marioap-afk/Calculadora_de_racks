...
| I-39 | (paraguas: se ejecuta por subiniciativas) ✋ | **Contrato funcional común de ventanas WPF**: ADR-0019 unificó la **composición visual** de los editores ricos; lo **funcional** sigue sin contrato —estado, transacción, acciones y motivos de bloqueo, validación, preview, dirty, cierre, teclado, foco, ownership, tamaño, diagnóstico y recomputación observable—. La infraestructura ya escrita (`EditorAction.DisabledReason`, `EditorActionBar`, `EditorStatusPresenter`, `RackDialogWindow`, el **tipo** `PreviewCanvas`) tiene cero o casi cero consumidores productivos. **Esta fila no se ejecuta directamente**: I-39 se ejecuta por subiniciativas y esta entrada es su índice. Contrato funcional en [ADR-0029](adr/0029-contrato-funcional-comun-de-ventanas-wpf.md); decisiones del Owner en [`decisions/I-39.md`](automation/decisions/I-39.md) | L (partida) | I-14, I-15, I-24, I-30, I-31, I-37D (integradas) | — | pendiente — I-39A, I-39B e I-39C integradas; **queda solo I-39D**, con la que se cierra la línea |
