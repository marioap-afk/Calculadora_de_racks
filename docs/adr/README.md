...
| [0027](0027-linea-cantilever-intervalos-y-arriostramiento.md) | La línea Cantilever: intervalos, distribución de paneles y arriostramiento | propuesto |
| [0028](0028-cantilever-persistencia-vistas-editor-y-dibujo.md) | Cantilever visible: persistencia, registro, vistas, editor y materialización | propuesto |
...
Iniciativa I-37D (`feature/cantilever-mvp-final`): **ADR-0027 y ADR-0028 nacen `propuestos`**, y entre los dos
cierran el MVP. **ADR-0027** decide la geometría de la línea: que un intervalo es del **par** de estaciones
