...
| Estado | P3 conservada como historial; decision B registrada en P4 |
...
clasificaciones, confianza, fuentes y limites completos. P4 registra B como decision interna de
gestion del riesgo; no como conclusion juridica.

En las quince respuestas rige la marca historica: **Propuesta preliminar de P3; sustituida como
decision de gestion por B en P4.**
...
| Respuesta propuesta | No autorizar el merge hasta confirmacion escrita competente. Propuesta preliminar historica de P3; sustituida como decision de gestion por B en P4. |
...
| ¿Requiere asesoría externa? | Si. |
| Respuesta propuesta | Mantener bloqueada salvo confirmacion conjunta con la pregunta 1. Propuesta preliminar historica de P3; sustituida como decision de gestion por B en P4. |
...
| ¿Requiere asesoría externa? | Si. |
| Respuesta propuesta | No reconocer a GitHub como autorizado sin criterio escrito competente. Propuesta preliminar historica de P3; sustituida como decision de gestion por B en P4. |
...
| Respuesta propuesta | No usar `actions/cache` con material Autodesk. Propuesta preliminar historica de P3; sustituida como decision de gestion por B en P4. |
...
| Respuesta propuesta | Si, solo tras aprobar excepcion y diseño de lock permanente. Propuesta preliminar historica de P3; sustituida como decision de gestion por B en P4. |
...
| Respuesta propuesta | Si, solo como evidencia de integridad. Propuesta preliminar historica de P3; sustituida como decision de gestion por B en P4. |
...
| ¿Requiere asesoría externa? | Si. |
| Respuesta propuesta | Tratar conservadoramente las seis DLL hasta criterio competente. Propuesta preliminar historica de P3; sustituida como decision de gestion por B en P4. |
...
| Respuesta propuesta | Solicitar confirmacion escrita antes del merge. Propuesta preliminar historica de P3; sustituida como decision de gestion por B en P4. |
...
| Respuesta propuesta | Si requiere validacion adicional; P3 aplico firma, hashes, owner y licencia. Propuesta preliminar historica de P3; sustituida como decision de gestion por B en P4. |
...
| ¿Requiere asesoría externa? | No para mantener la prohibicion. |
| Respuesta propuesta | No usar feed privado. Propuesta preliminar historica de P3; sustituida como decision de gestion por B en P4. |
...
| Respuesta propuesta | No autorizar dentro de P3; evaluar por separado. Propuesta preliminar historica de P3; sustituida como decision de gestion por B en P4. |
...
| Respuesta propuesta | Conservar acuerdo/avisos en toda copia Autodesk permitida; no añadir material al bundle. Propuesta preliminar historica de P3; sustituida como decision de gestion por B en P4. |
...
| Respuesta propuesta | Mantener modelo tecnico, sin presentar P3 como autorizacion de distribucion. Propuesta preliminar historica de P3; sustituida como decision de gestion por B en P4. |
...
| ¿Requiere asesoría externa? | Si. |
| Respuesta propuesta | No autorizar distribucion externa por analogia con uso interno. Propuesta preliminar historica de P3; sustituida como decision de gestion por B en P4. |
...
| ¿Requiere asesoría externa? | Si. |
| Respuesta propuesta | No concluir si o no; solicitar confirmacion expresa. Propuesta preliminar historica de P3; sustituida como decision de gestion por B en P4. |
...
| Caching | `actions/cache` no autorizado; copia efimera aceptada como riesgo interno restringido |
| Artifacts | Material Autodesk prohibido; RackCad solo con guarda de ausencia total |
| Redistribución | Material Autodesk prohibido; RackCad aprobado solo para uso interno y bundle limpio |
| Uso interno/externo | Uso interno aprobado; distribucion externa fuera de alcance |
...
| A/B/C/D seleccionado | B. Aprobado con restricciones |
| Mecanismo verificable | Instruccion escrita del Owner registrada en P4 |
| Fecha y vigencia | 2026-07-20; cambio material o maximo 2027-07-20 |
| ADR-0003 | Propuesto |
| Excepcion cero NuGet | No vigente |
| I-13 y merge | Abiertos y bloqueados |

## Recomendacion preliminar historica y decision P4
...
El Owner reviso esa recomendacion y selecciono **B. Aprobado con restricciones**. Acepta como riesgo
interno residual la falta de autorizacion Autodesk expresa localizada para GitHub-hosted runners.
La decision solo cubre RackCad, uso interno, las versiones auditadas y compile-only. Mantiene
ADR-0003 propuesto, cero NuGet vigente, I-13 abierta y el merge bloqueado.
