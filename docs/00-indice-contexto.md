...
Cuatro tipos de rack (cabecera, dinamico, cama, selectivo) con ventana editora, dibujo en AutoCAD y round-trip de edicion. El cierre tecnico de `codex/dinamico-modular` tiene **627/627 pruebas verdes** y build Debug completo sin errores. El ultimo espejo/orientacion del desviador en la frontal de entrada conserva una comprobacion manual pendiente con los bloques DWG reales; el resto del lote dinamico fue validado visualmente durante su desarrollo.
