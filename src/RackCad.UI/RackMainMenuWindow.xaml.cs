...
namespace RackCad.UI
{
    ...
    public partial class RackMainMenuWindow : Window
    {
        ...
        // The seven "Diseñar …" buttons: each names its kind and delegates to the shared, registry-driven launcher. No
        ...
        private void DesignCantilever_Click(object sender, RoutedEventArgs e) => LaunchDesignModule(RackSystemKind.Cantilever);
