...
namespace RackCad.Application.RackFrames
{
    ...
    public sealed class PlantaHeaderLayoutBuilder
    {
        ...
        private const string LengthParam = Domain.Systems.Selective.SelectiveRackDefaults.LengthParam;
        private const string PeralteParam = Domain.Systems.Selective.SelectiveRackDefaults.PeralteParam;
