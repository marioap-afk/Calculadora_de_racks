...
namespace RackCad.Application.Systems.Selective
{
    ...
    public sealed class SelectiveFrontalBuilder
    {
        ...
        /// nest <see cref="HeaderRunPlan.Headers"/>.
        /// </summary>
            ...
            for (var i = 0; i < postX.Count; i++)
            {
                ...
                else
                {
                    SelectiveSafetyPlacement.AppendAtPost(
                        instances, catalog, view, botas, origin, plateId, i, physicalFaces: true);
                }
            }
        ...
        /// <summary>How many pieces of width <paramref name="frente"/> fit in <paramref name="span"/> (0 if the frente is
